#
#  Start EDU25R Basic on disk created by build.tcl
...
lookforprompt "."
checkttyprompt "" "R EDU25R"
checkttymatch 0 "ILLEGAL OS/8 DEVICE FOUND"
checkttymatch 0 "NO BOOTSTRAP POSSIBLE!"
checkttymatch 0 "EDUSYSTEM 25-F BASIC"
answerprompt "NUMBER OF USERS (1 TO 5)?" "3"
