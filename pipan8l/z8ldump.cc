    ...
    *lxmemrange = NULL;
    ...
    while (! exitflag) {
        ...
        if (xmemranges == NULL) {
            ...
            printf ("  oBIOP1=%o             oBAC=%04o           brkwhenhltd=%o      iBEMA=%o              iDMAADDR=%04o     S majstate=%s%s",      FIELD(Z_RF,f_oBIOP1),         FIELD(Z_RH,h_oBAC),           FIELD(Z_RE,e_brkwhenhltd), FIELD(Z_RA,a_iBEMA),         FIELD(Z_RD,d_iDMAADDR),   majstatenames[FIELD(Z_RK,k_majstate)],   eol);
