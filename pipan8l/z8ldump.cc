    ...
    *lxmemrange = NULL;
    ...
    while (! exitflag) {
        ...
        if (xmemranges == NULL) {
            ...
            printf ("  oBTP3=%o              lbBRK=%o             fpgareset=%o        i_MEM_P=%o            swCONT=%o            cyclectr=%04o%s",  FIELD(Z_RF,f_oBTP3),          FIELD(Z_RG,g_lbBRK),          FIELD(Z_RE,e_fpgareset),   FIELD(Z_RA,a_i_MEM_P),       FIELD(Z_RB,b_swCONT),     FIELD(Z_RK,k_cyclectr),                  eol);
