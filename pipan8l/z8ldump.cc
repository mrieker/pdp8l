    ...
    *lxmemrange = NULL;
    ...
    while (! exitflag) {
        ...
        if (xmemranges == NULL) {
            ...
            printf ("  o_DF_ENABLE=%o        lbMA=%04o           r_BAC=%o            didio=%o%s",                                                   FIELD(Z_RF,f_o_DF_ENABLE),    FIELD(Z_RJ,j_lbMA),           FIELD(Z_RO,o_r_BAC),       FIELD(Z_RF,f_didio),                                                                            eol);
            printf ("  o_KEY_CLEAR=%o        lbMB=%04o           r_BMB=%o            hizmembus=%o%s",                                               FIELD(Z_RF,f_o_KEY_CLEAR),    FIELD(Z_RJ,j_lbMB),           FIELD(Z_RO,o_r_BMB),       FIELD(Z_RO,o_hizmembus),                                                                        eol);
