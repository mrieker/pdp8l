...
#define e_bareit        (1U <<  6)  //rw 0=pass device data to PDP-8/L & sim 'i' pins
                                    //   1=pass arm reg data to PDP-8/L & sim 'i' pins
...
#define FP5_I2CSTATE    (7U << 19)
#define FP5_I2CCLI      (1U << 28)
