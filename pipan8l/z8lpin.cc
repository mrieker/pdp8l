...
static PinDef const pindefs[] = {
    ...
    { "iB36V1",          DEV_8L, Z_RA, a_iB36V1,           true  },
    { "iD36B2",          DEV_8L, Z_RA, a_iD36B2,           true  },
    ...
    { "iMEM_02",         DEV_8L, Z_RC, c_iMEM0 <<  9,      true  },
    { "iMEM_03",         DEV_8L, Z_RC, c_iMEM0 <<  8,      true  },
    { "iMEM_04",         DEV_8L, Z_RC, c_iMEM0 <<  7,      true  },
    { "iMEM_05",         DEV_8L, Z_RC, c_iMEM0 <<  6,      true  },
    { "iMEM_06",         DEV_8L, Z_RC, c_iMEM0 <<  5,      true  },
    { "iMEM_07",         DEV_8L, Z_RC, c_iMEM0 <<  4,      true  },
    { "iMEM_08",         DEV_8L, Z_RC, c_iMEM0 <<  3,      true  },
    { "iMEM_09",         DEV_8L, Z_RC, c_iMEM0 <<  2,      true  },
    { "iMEM_10",         DEV_8L, Z_RC, c_iMEM0 <<  1,      true  },
    { "iMEM_11",         DEV_8L, Z_RC, c_iMEM0 <<  0,      true  },
    { "i_DMAADDR",       DEV_8L, Z_RD, d_i_DMAADDR,        true  },
    { "i_DMAADDR_00",    DEV_8L, Z_RD, d_i_DMAADDR0 << 11, true  },
    { "i_DMAADDR_01",    DEV_8L, Z_RD, d_i_DMAADDR0 << 10, true  },
    { "i_DMAADDR_02",    DEV_8L, Z_RD, d_i_DMAADDR0 <<  9, true  },
    { "i_DMAADDR_03",    DEV_8L, Z_RD, d_i_DMAADDR0 <<  8, true  },
    { "i_DMAADDR_04",    DEV_8L, Z_RD, d_i_DMAADDR0 <<  7, true  },
    { "i_DMAADDR_05",    DEV_8L, Z_RD, d_i_DMAADDR0 <<  6, true  },
    { "i_DMAADDR_06",    DEV_8L, Z_RD, d_i_DMAADDR0 <<  5, true  },
    { "i_DMAADDR_07",    DEV_8L, Z_RD, d_i_DMAADDR0 <<  4, true  },
    { "i_DMAADDR_08",    DEV_8L, Z_RD, d_i_DMAADDR0 <<  3, true  },
    { "i_DMAADDR_09",    DEV_8L, Z_RD, d_i_DMAADDR0 <<  2, true  },
    { "i_DMAADDR_10",    DEV_8L, Z_RD, d_i_DMAADDR0 <<  1, true  },
    { "i_DMAADDR_11",    DEV_8L, Z_RD, d_i_DMAADDR0 <<  0, true  },
    { "i_DMADATA",       DEV_8L, Z_RD, d_i_DMADATA,        true  },
    { "i_DMADATA_00",    DEV_8L, Z_RD, d_i_DMADATA0 << 11, true  },
    { "i_DMADATA_01",    DEV_8L, Z_RD, d_i_DMADATA0 << 10, true  },
    { "i_DMADATA_02",    DEV_8L, Z_RD, d_i_DMADATA0 <<  9, true  },
    { "i_DMADATA_03",    DEV_8L, Z_RD, d_i_DMADATA0 <<  8, true  },
    { "i_DMADATA_04",    DEV_8L, Z_RD, d_i_DMADATA0 <<  7, true  },
    { "i_DMADATA_05",    DEV_8L, Z_RD, d_i_DMADATA0 <<  6, true  },
    { "i_DMADATA_06",    DEV_8L, Z_RD, d_i_DMADATA0 <<  5, true  },
    { "i_DMADATA_07",    DEV_8L, Z_RD, d_i_DMADATA0 <<  4, true  },
    { "i_DMADATA_08",    DEV_8L, Z_RD, d_i_DMADATA0 <<  3, true  },
    { "i_DMADATA_09",    DEV_8L, Z_RD, d_i_DMADATA0 <<  2, true  },
    { "i_DMADATA_10",    DEV_8L, Z_RD, d_i_DMADATA0 <<  1, true  },
    { "i_DMADATA_11",    DEV_8L, Z_RD, d_i_DMADATA0 <<  0, true  },
